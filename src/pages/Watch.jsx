...
<div className="d-flex justify-content-between">
  <h3>Watch History</h3>
  <Link  to={'/home'}><i className="fa-sharp fa-solid fa-arrow-left-long"></i> Back To <i className="fa-solid fa-home"></i></Link>
</div>
...
:
<tr className='text-danger fw-bolder'>Your Watch History is emptey!!!</tr>
}
  </tbody>
</table>
    </div>
